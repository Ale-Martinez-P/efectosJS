...
var mf = {
	...
	validarFormulario: function() {
		...
		if (!pf.validarUsuario || !pf.validarPassword || !pf.validarEmail) {
			...
			document.querySelector("#labelEnviar").innerHTML = '<span style="color:red">*Tiene errores en los datos ingresados, Favor Volver a Revisar </span>';
			return false;
		} else if (!pf.validarTerminos) {

			document.querySelector("#labelEnviar").innerHTML = '<span style="color:red">*No Acepto Los Terminos y Condiciones</span>';
			return false;
		} else {
			return true;
		}
